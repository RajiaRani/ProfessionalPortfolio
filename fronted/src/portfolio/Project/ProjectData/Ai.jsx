    ...
    return (
        <div className="project-container">
            <div className="project-detail">
                ...
                <p>
                    The <strong>AI-Powered Real Estate Matching Application</strong> leverages cutting-edge artificial intelligence to revolutionize the real estate experience. By integrating advanced machine learning models like GPT-4, this system automates the generation of property listings and descriptions, offering a personalized experience for each user.
                </p>
                <br />
                <img src={ai} alt="AI-Powered Real Estate Matching" className="projectImg" />
                <h3>Technologies and Methods Used: </h3>
                <div className="tech-stack">
                    <h4>AI and Natural Language Processing (NLP)</h4>
                    <ul>
